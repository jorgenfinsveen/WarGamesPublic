...
/**
 * Controller for the unit configurator scene for army 1
 *  
 * @author jorgfi
 */
...
// SETTERS ------------------------------------------------------------------------------------------------
    ...
    /**
     * Sets the TableView for army1 in armyConfiguratorPage
     * @param tableView TableView to set
     */
    public void setTableView(TableView tableView) {
        this.army1Table = tableView;
    }
        ...
        if (inputUnitHealth.getText() == "" || inputUnitAmount.getText() == "" ||
            ...
            if (!editingUnit) {
                ...
                if (inputUnitAttack.getText() == "" || inputUnitArmor.getText() == "") {
                    armyConfiguratorController.addUnitsToTable1(type, name, amount, health, 0, 0, false);
                } else {
                    int attack = Integer.parseInt(inputUnitAttack.getText());
                    int armor = Integer.parseInt(inputUnitArmor.getText());
                    armyConfiguratorController.addUnitsToTable1(type, name, amount, health, attack, armor, true);
                }
            } 
            editingUnit = false;
